...
if __name__ == '__main__':
    ...
    with Path('results/params.json').open('w',encoding='utf8') as f:
    ...
    def write_predictions(name):
        ...
        with Path('results/score/{}.preds.txt'.format(name)).open('wb',encoding='utf8') as f:
